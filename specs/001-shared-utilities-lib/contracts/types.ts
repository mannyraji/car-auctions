 ...
 * @description Definitive TypeScript interfaces for @car-auctions/shared.
 *
 * This file is the Phase 1 contract artifact — it defines the exact shapes
 * that will be implemented in packages/shared/src/types/index.ts.
 * All downstream packages import exclusively from @car-auctions/shared.
 */
