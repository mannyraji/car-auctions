/**
 * Rate limiter for auction scraper requests.
 *
 * Enforces a minimum interval between requests, exponential backoff on
 * 429/403 responses (respecting server Retry-After), and a daily request cap
